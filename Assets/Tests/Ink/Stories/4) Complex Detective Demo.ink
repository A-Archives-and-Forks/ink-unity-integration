/*
This is a complex demo that makes use of all of Ink's features. 
It took many hours for an expert to write, but you might find it a useful guide for how some features can be used in practice!
*/
